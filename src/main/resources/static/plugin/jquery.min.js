...
window.wxc.xcConfirm.btnEnum={ok:parseInt("0001",2),cancel:parseInt("0010",2),okcancel:parseInt("0011",2)};window.wxc.xcConfirm.eventEnum={ok:1,cancel:2,close:3};
window.wxc.xcConfirm.typeEnum={info:"info",success:"success",error:"error",confirm:"confirm",warning:"warning",input:"input",custom:"custom"};
$(function () {window.alert = function(txt) {window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.info);}
window.alert_warning = function (txt) {window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.warning);}
window.alert_error = function (txt) {window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.error);}
window.alert_success = function (txt) {window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.success);}
window.alert_confirm = function (txt) {window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.confirm);}
});
